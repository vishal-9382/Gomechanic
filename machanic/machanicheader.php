...
<head>
    ...
    <title>GoMechanic - Mechanic Panel</title>
    <!-- Bootstrap 5.3.3 CSS -->
...
<nav class="navbar navbar-expand-lg">
    <div class="container-fluid">
        <a class="navbar-brand d-flex align-items-center" href="professionalhome.php">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto align-items-center">
                <li class="nav-item">
                    <a class="nav-link" href="professionalhome.php">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="viewwork.php">View Work</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="mechanic_contact.php">Contact us</a>
                </li>
                <li class="nav-item">
